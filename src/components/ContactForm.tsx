        ...
        <div className="flex-1 bg-[#1a1c1d] p-8 rounded-lg shadow-2xl border border-[#bba373]/20">
          <form className="flex flex-col gap-5">
            ...
            <div>
              ...
              <textarea id="message" rows={4} className="w-full px-4 py-3 border-b border-[#f5f1e8]/20 bg-transparent text-[#f5f1e8] focus:outline-none focus:border-[#bba373] transition-colors resize-none" placeholder="Tell us about your ideal journey..."></textarea>
            </div>
