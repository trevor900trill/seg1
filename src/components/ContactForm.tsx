    ...
    <section id="contact" className="bg-[#2c3031] text-[#f5f1e8] py-20 px-6">
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-12">
        <div className="flex-1">
          <h2 className="text-4xl md:text-5xl font-serif text-[#bba373] mb-6">Curate Your Journey</h2>
          <p className="text-[#f5f1e8]/80 text-lg mb-8 leading-relaxed">
            Reach out to us to begin planning your extraordinary African experience. All inquiries are treated with strict confidentiality.
          </p>
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-[#f5f1e8]/70">concierge@outreachtours.com</p>
            </div>
          </div>
        </div>
        <div className="flex-1 bg-[#1a1c1d] p-8 rounded-lg shadow-2xl border border-[#bba373]/20">
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div>
              <label className="block text-sm font-semibold mb-2 text-[#bba373]" htmlFor="message">Your Vision</label>
              <textarea id="message" rows={4} value={formData.message} onChange={handleChange} required className="w-full px-4 py-3 border-b border-[#f5f1e8]/20 bg-transparent text-[#f5f1e8] focus:outline-none focus:border-[#bba373] transition-colors resize-none" placeholder="Tell us about your ideal journey..."></textarea>
            </div>
            ...
            {status === 'success' && (
              <div className="mt-4 p-4 rounded-lg bg-[#bba373]/10 border border-[#bba373]/40 text-[#f5f1e8] flex items-center gap-3 transition-all duration-300">
                ...
                <div>
                  <h5 className="font-semibold text-[#bba373]">Inquiry Received</h5>
